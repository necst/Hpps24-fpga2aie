...
while.body2:                                      ; preds = %while.body2.preheader, %while.body2
  ...
  %proc_24_1_bounds.02 = phi i32 [ %spec.select, %while.body2 ], [ %0, %while.body2.preheader ]
  call addrspace(1) void @llvm.dbg.value(metadata i32 %index.13, metadata !890, metadata !DIExpression()), !dbg !908
  call addrspace(1) void @llvm.dbg.value(metadata i32 %proc_24_1_bounds.02, metadata !893, metadata !DIExpression()), !dbg !911
  call addrspace(1) void @_Z22reduce_kernel_functionP12input_streamIfES1_P13output_streamIfE(i32 undef, i32 undef, i32 undef) #23, !dbg !915, !noalias !900
  ...
  %cmp = icmp sgt i32 %proc_24_1_bounds.02, 0, !dbg !919
  %dec = add nsw i32 %proc_24_1_bounds.02, -1
  %spec.select = select i1 %cmp, i32 %dec, i32 %proc_24_1_bounds.02, !dbg !921
...
entry:
  ...
  call addrspace(1) void @_Z7put_wmsi7v4int32i(i32 %idx_ms, %struct.v4int32 %2, i32 %tlast) #29
  ret void
}
...
define dso_local void @_Z26reduce_vec_kernel_functionP12input_streamIfES1_P13output_streamIfE(i32 chesscopy %input_1, i32 chesscopy %input_2, i32 chesscopy %output) addrspace(1) #22 !dbg !2251 {
entry:
  ...
  %7 = call addrspace(1) %"class.aie::detail::vector" @_Z10readincr_vILj8EL22aie_stream_resource_in0EfEN3aie6detail6vectorIT1_XT_EEEP12input_streamIS4_E(i32 %input_1) #23, !dbg !2278, !noalias !2268
  ...
  %13 = call addrspace(1) %"class.aie::detail::vector" @_Z10readincr_vILj8EL22aie_stream_resource_in0EfEN3aie6detail6vectorIT1_XT_EEEP12input_streamIS4_E(i32 %input_2) #23, !dbg !2279, !noalias !2268
  ...
  call addrspace(1) void @_Z9writeincrIL23aie_stream_resource_out0EfLj8EEvP13output_streamIT0_ERKN3aie6detail6vectorIS2_XT1_EEE(i32 %output, %"class.aie::detail::vector"* nonnull align 32 dereferenceable(32) %z) #23, !dbg !2283, !noalias !2268
...
entry:
  ...
  call addrspace(1) void @_ZN3aie6detail3adf17stream_out_helperILj8EfL23aie_stream_resource_out0EE9writeincrEP13output_streamIfENS0_6vectorIfLj8EEE(i32 %w, %"class.aie::detail::vector" %0) #23, !dbg !2305
  ret void, !dbg !2306
}
...
for.body:                                         ; preds = %for.body, %entry
  ...
  call addrspace(1) void @_ZL9writeincrIL23aie_stream_resource_out0EEvP13output_streamIfE7v4floatb(i32 %w, %struct.v4float %5) #23, !dbg !2320
...
; Function Attrs: alwaysinline nounwind mustprogress
define internal void @_ZL9writeincrIL23aie_stream_resource_out0EEvP13output_streamIfE7v4floatb(i32 %str, %struct.v4float %value.coerce) addrspace(1) #9 !dbg !2331 {
entry:
  ...
  call addrspace(1) void @_ZL9writeincrIL23aie_stream_resource_out0EEvP13output_streamIsE7v8int16b(i32 %str, %struct.v8int16 %2, i1 zeroext %tobool) #23, !dbg !2342
  ret void, !dbg !2342
}

; Function Attrs: alwaysinline nounwind mustprogress
define internal void @_ZL9writeincrIL23aie_stream_resource_out0EEvP13output_streamIsE7v8int16b(i32 %ss, %struct.v8int16 %value.coerce, i1 zeroext %tlast) addrspace(1) #9 !dbg !2343 {
entry:
  ...
  call addrspace(1) void @_ZN12stream_utilsL18aie_stream_put_wmsIsEEvP13output_streamIsE7v8int16Rb(i32 %ss, %struct.v8int16 %value.coerce, i8 %tlast.addr.val) #23, !dbg !2357
  ret void, !dbg !2358
}

; Function Attrs: alwaysinline nounwind mustprogress
define internal void @_ZN12stream_utilsL18aie_stream_put_wmsIsEEvP13output_streamIsE7v8int16Rb(i32 %ss, %struct.v8int16 %value.coerce, i8 %tlast.val) addrspace(1) #9 !dbg !2359 {
entry:
  ...
  call addrspace(1) void @_Z7put_wmsi7v8int16i(i32 %ss, %struct.v8int16 %value.coerce, i32 %conv) #34, !dbg !2373
  ret void, !dbg !2374
}
...
; Function Attrs: alwaysinline nounwind mustprogress
define dso_local void @_Z22reduce_kernel_functionP12input_streamIfES1_P13output_streamIfE(i32 chesscopy %input_1, i32 chesscopy %input_2, i32 chesscopy %output) addrspace(1) #9 !dbg !2423 {
entry:
  %x = alloca %"class.aie::detail::vector", align 32
  %custom_type.tmp = alloca %"class.aie::detail::vector", align 32
  %y = alloca %"class.aie::detail::vector", align 32
  ...
  %7 = call addrspace(1) %"class.aie::detail::vector" @_Z10readincr_vILj8EL22aie_stream_resource_in0EfEN3aie6detail6vectorIT1_XT_EEEP12input_streamIS4_E(i32 0) #23, !dbg !2446, !noalias !2436
  ...
  %13 = call addrspace(1) %"class.aie::detail::vector" @_Z10readincr_vILj8EL22aie_stream_resource_in0EfEN3aie6detail6vectorIT1_XT_EEEP12input_streamIS4_E(i32 1) #23, !dbg !2447, !noalias !2436
  ...
  call addrspace(1) void @_ZL9writeincrIL23aie_stream_resource_out0EfEvP13output_streamIT0_ENSt3__213type_identityIS2_E4typeEb(float %call11) #23, !dbg !2453
...
; Function Attrs: alwaysinline nounwind mustprogress
define internal void @_ZL9writeincrIL23aie_stream_resource_out0EfEvP13output_streamIT0_ENSt3__213type_identityIS2_E4typeEb(float %value) addrspace(1) #9 !dbg !2455 {
entry:
  ...
  call addrspace(1) void @_ZN12stream_utilsL17aie_stream_put_msIffEEvP13output_streamIT0_Eib(i32 %call, i1 zeroext %tobool) #23, !dbg !2483
  ret void, !dbg !2484
}

; Function Attrs: alwaysinline nounwind mustprogress
define internal void @_ZN12stream_utilsL17aie_stream_put_msIffEEvP13output_streamIT0_Eib(i32 %value, i1 zeroext %tlast) addrspace(1) #9 !dbg !2485 {
entry:
  ...
  call addrspace(1) void @_Z6put_msiii(i32 0, i32 %value, i32 %conv) #29, !dbg !2498
  ret void, !dbg !2499
}
...
!893 = !DILocalVariable(name: "proc_24_1_bounds", scope: !894, file: !377, line: 35, type: !891)
