; ModuleID = '/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/aie/Work/aie/25_1/src/25_1.cc'
source_filename = "/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/aie/Work/aie/25_1/src/25_1.cc"
...
entry:
  ...
  %proc_25_1_bounds = alloca i32, align 4
...
while.body:                                       ; preds = %while.cond
  store i32 undef, i32* %proc_25_1_bounds, align 4, !dbg !955, !noalias !930
  %7 = bitcast i32* %proc_25_1_bounds to i8*, !dbg !955
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %7) #24, !dbg !955, !noalias !930
  call addrspace(1) void @llvm.dbg.declare(metadata i32* %proc_25_1_bounds, metadata !928, metadata !DIExpression()), !dbg !956
  ...
  store i32 %8, i32* %proc_25_1_bounds, align 4, !dbg !956, !tbaa !936, !noalias !930
  br label %while.cond1, !dbg !958

while.cond1:                                      ; preds = %if.end, %while.body
  %9 = load i32, i32* %proc_25_1_bounds, align 4, !dbg !959, !tbaa !936, !noalias !930
  %tobool = icmp ne i32 %9, 0, !dbg !959
  br i1 %tobool, label %while.body2, label %while.end, !dbg !958

while.body2:                                      ; preds = %while.cond1
  call addrspace(1) void @_Z26reduce_vec_kernel_functionP12input_streamIfES1_P13output_streamIfE(%struct.input_stream.0* %stream_0, %struct.input_stream.0* %stream_1, %struct.output_stream.2* %stream_2) #25, !dbg !960, !noalias !930
  ...
  %11 = load i32, i32* %proc_25_1_bounds, align 4, !dbg !966, !tbaa !936, !noalias !930
  %cmp = icmp sgt i32 %11, 0, !dbg !968
  br i1 %cmp, label %if.then, label %if.end, !dbg !969

if.then:                                          ; preds = %while.body2
  %12 = load i32, i32* %proc_25_1_bounds, align 4, !dbg !970, !tbaa !936, !noalias !930
  %dec = add nsw i32 %12, -1, !dbg !970
  store i32 %dec, i32* %proc_25_1_bounds, align 4, !dbg !970, !tbaa !936, !noalias !930
...
cleanup:                                          ; preds = %if.end5, %if.then4
  %14 = bitcast i32* %proc_25_1_bounds to i8*, !dbg !980
...
!3 = !DIFile(filename: "/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/aie/Work/aie/25_1/src/25_1.cc", directory: "/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/aie/Work/aie")
!4 = !{!5, !15}
...
!377 = !DIFile(filename: "25_1/src/25_1.cc", directory: "/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/aie/Work/aie")
...
!928 = !DILocalVariable(name: "proc_25_1_bounds", scope: !929, file: !377, line: 35, type: !926)
