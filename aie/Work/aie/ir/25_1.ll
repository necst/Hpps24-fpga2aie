...
while.body2:                                      ; preds = %while.body2.preheader, %while.body2
  ...
  %proc_25_1_bounds.02 = phi i32 [ %spec.select, %while.body2 ], [ %0, %while.body2.preheader ]
  call addrspace(1) void @llvm.dbg.value(metadata i32 %index.13, metadata !890, metadata !DIExpression()), !dbg !908
  call addrspace(1) void @llvm.dbg.value(metadata i32 %proc_25_1_bounds.02, metadata !893, metadata !DIExpression()), !dbg !911
  ...
  %cmp = icmp sgt i32 %proc_25_1_bounds.02, 0, !dbg !919
  %dec = add nsw i32 %proc_25_1_bounds.02, -1
  %spec.select = select i1 %cmp, i32 %dec, i32 %proc_25_1_bounds.02, !dbg !921
...
!893 = !DILocalVariable(name: "proc_25_1_bounds", scope: !894, file: !377, line: 35, type: !891)
