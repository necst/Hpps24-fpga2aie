...
void reduce_kernel_function(input_stream<float> *,input_stream<float> *,output_stream<float> *);
...
int main(void) {
  ...
  while (proc_24_1_bounds)
  {
    ...
    // Kernel call : i18:reduce_kernel_function
    reduce_kernel_function(&stream_0,&stream_1,&stream_2);
    index = 1 - index;
