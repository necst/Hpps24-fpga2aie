...
open_project sink_from_aie
set_top sink_from_aie
# v++ -g, -D, -I, --advanced.prop kernel.sink_from_aie.kernel_flags
add_files "/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/data_movers/sink_from_aie.cpp" -cflags " -g"
...
config_export -format xo -ipname sink_from_aie
csynth_design
export_design
close_project
