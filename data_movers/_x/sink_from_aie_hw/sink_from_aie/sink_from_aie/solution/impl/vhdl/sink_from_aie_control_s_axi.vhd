...
entity sink_from_aie_control_s_axi is
generic (
...
end entity sink_from_aie_control_s_axi;
...
architecture behave of sink_from_aie_control_s_axi is
    ...
    constant ADDR_OUTPUT_R_DATA_0 : INTEGER := 16#10#;
    constant ADDR_OUTPUT_R_DATA_1 : INTEGER := 16#14#;
    constant ADDR_OUTPUT_R_CTRL   : INTEGER := 16#18#;
