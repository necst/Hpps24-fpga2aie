...
extern "C" void sink_from_aie(Byte<4>*, __cosim_s4__*, int);
extern "C" void apatb_sink_from_aie_hw(volatile void * __xlx_apatb_param_input_stream, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_size_param_output_r = 100;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*4;
auto* sinput_stream = createStream((hls::stream<__cosim_s4__>*)__xlx_apatb_param_input_stream);
  // DUT call
  sink_from_aie(__xlx_output_r__tmp_vec.data(), sinput_stream->data<__cosim_s4__>(), __xlx_offset_byte_param_output_r);
...
sinput_stream->transfer((hls::stream<__cosim_s4__>*)__xlx_apatb_param_input_stream);
}
