...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "input_stream", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "output_r", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"sink_from_aie","role":"start","value":"0","valid_bit":"0"},{"name":"sink_from_aie","role":"continue","value":"0","valid_bit":"4"},{"name":"sink_from_aie","role":"auto_start","value":"0","valid_bit":"7"},{"name":"output_r","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"sink_from_aie","role":"start","value":"0","valid_bit":"0"},{"name":"sink_from_aie","role":"done","value":"0","valid_bit":"1"},{"name":"sink_from_aie","role":"idle","value":"0","valid_bit":"2"},{"name":"sink_from_aie","role":"ready","value":"0","valid_bit":"3"},{"name":"sink_from_aie","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_input_stream_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	input_stream { axis {  { input_stream_TDATA in_data 0 32 }  { input_stream_TVALID in_vld 0 1 }  { input_stream_TREADY in_acc 1 1 } } }
}
