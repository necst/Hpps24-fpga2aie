...
HD_PWD='/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/data_movers/_x/sink_from_aie_hw/sink_from_aie'
cd "$HD_PWD"
...
EAStep vitis_hls -f sink_from_aie.tcl -messageDb vitis_hls.pb
