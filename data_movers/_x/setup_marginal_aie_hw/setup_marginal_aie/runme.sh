...
HD_PWD='/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/data_movers/_x/setup_marginal_aie_hw/setup_marginal_aie'
cd "$HD_PWD"
...
EAStep vitis_hls -f setup_marginal_aie.tcl -messageDb vitis_hls.pb
