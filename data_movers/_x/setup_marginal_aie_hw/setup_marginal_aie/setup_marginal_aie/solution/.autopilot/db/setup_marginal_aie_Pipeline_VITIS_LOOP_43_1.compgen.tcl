...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_TREADY { I 1 bit } s_TDATA { O 32 vector } s_TVALID { O 1 bit } } \
} "
} else {
...
set InstName setup_marginal_aie_flow_control_loop_pipe_sequential_init_U
set CompName setup_marginal_aie_flow_control_loop_pipe_sequential_init
