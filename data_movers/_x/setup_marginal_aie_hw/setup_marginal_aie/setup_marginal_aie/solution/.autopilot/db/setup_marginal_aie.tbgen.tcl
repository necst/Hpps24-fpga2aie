set moduleName setup_marginal_aie
set isTopModule 1
...
set hasInterrupt 0
set C_modelName {setup_marginal_aie}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ image_size int 32 regular {axi_slave 0}  }
	{ histogram_rows int 64 regular {axi_slave 0}  }
	{ s int 32 regular {axi_s 1 volatile  { s Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "histogram_rows","offset": { "type": "dynamic","port_name": "histogram_rows","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "s", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ s_TDATA sc_out sc_lv 32 signal 3 } 
	{ s_TVALID sc_out sc_logic 1 outvld 3 } 
	{ s_TREADY sc_in sc_logic 1 outacc 3 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"setup_marginal_aie","role":"start","value":"0","valid_bit":"0"},{"name":"setup_marginal_aie","role":"continue","value":"0","valid_bit":"4"},{"name":"setup_marginal_aie","role":"auto_start","value":"0","valid_bit":"7"},{"name":"image_size","role":"data","value":"16"},{"name":"histogram_rows","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"setup_marginal_aie","role":"start","value":"0","valid_bit":"0"},{"name":"setup_marginal_aie","role":"done","value":"0","valid_bit":"1"},{"name":"setup_marginal_aie","role":"idle","value":"0","valid_bit":"2"},{"name":"setup_marginal_aie","role":"ready","value":"0","valid_bit":"3"},{"name":"setup_marginal_aie","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "s_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "s", "role": "TDATA" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4", "5"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_setup_marginal_aie_Pipeline_VITIS_LOOP_43_1_fu_103", "Port" : "gmem0", "Inst_start_state" : "72", "Inst_end_state" : "73"}]},
			...
			{"Name" : "s", "Type" : "Axis", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_setup_marginal_aie_Pipeline_VITIS_LOOP_43_1_fu_103", "Port" : "s", "Inst_start_state" : "72", "Inst_end_state" : "73"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_setup_marginal_aie_Pipeline_VITIS_LOOP_43_1_fu_103", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "setup_marginal_aie_Pipeline_VITIS_LOOP_43_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_setup_marginal_aie_Pipeline_VITIS_LOOP_43_1_fu_103.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.control_s_axi_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gmem0_m_axi_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	...
	setup_marginal_aie_Pipeline_VITIS_LOOP_43_1 {
		gmem0 {Type I LastRead 1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	s { axis {  { s_TDATA out_data 1 32 }  { s_TVALID out_vld 1 1 }  { s_TREADY out_acc 0 1 } } }
}
