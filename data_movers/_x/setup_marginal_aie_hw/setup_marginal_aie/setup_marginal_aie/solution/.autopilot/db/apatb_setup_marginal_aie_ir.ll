; ModuleID = '/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/data_movers/_x/setup_marginal_aie_hw/setup_marginal_aie/setup_marginal_aie/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_setup_marginal_aie_ir(i32 %image_size, i32* noalias nocapture nonnull readonly %histogram_rows, %"class.hls::stream<int, 0>"* noalias nocapture nonnull dereferenceable(4) %s) local_unnamed_addr #1 {
entry:
  %histogram_rows_copy = alloca [100 x i32], align 512
  %s_copy = alloca %"class.hls::stream<int, 0>", align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(%"class.hls::stream<int, 0>"* %s_copy, i32 0) ]
  %0 = bitcast i32* %histogram_rows to [100 x i32]*
  call fastcc void @copy_in([100 x i32]* nonnull %0, [100 x i32]* nonnull align 512 %histogram_rows_copy, %"class.hls::stream<int, 0>"* nonnull %s, %"class.hls::stream<int, 0>"* nonnull align 512 %s_copy)
  %1 = getelementptr inbounds [100 x i32], [100 x i32]* %histogram_rows_copy, i32 0, i32 0
  call void @apatb_setup_marginal_aie_hw(i32 %image_size, i32* %1, %"class.hls::stream<int, 0>"* %s_copy)
  call void @copy_back([100 x i32]* %0, [100 x i32]* %histogram_rows_copy, %"class.hls::stream<int, 0>"* %s, %"class.hls::stream<int, 0>"* %s_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in([100 x i32]* noalias readonly, [100 x i32]* noalias align 512, %"class.hls::stream<int, 0>"* noalias, %"class.hls::stream<int, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([100 x i32]* noalias, [100 x i32]* noalias readonly align 512, %"class.hls::stream<int, 0>"* noalias, %"class.hls::stream<int, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #6 {
entry:
...
declare void @apatb_setup_marginal_aie_hw(i32, i32*, %"class.hls::stream<int, 0>"*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back([100 x i32]* noalias, [100 x i32]* noalias readonly align 512, %"class.hls::stream<int, 0>"* noalias, %"class.hls::stream<int, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>"(%"class.hls::stream<int, 0>"* %2, %"class.hls::stream<int, 0>"* align 512 %3)
  ret void
}

define void @setup_marginal_aie_hw_stub_wrapper(i32, i32*, %"class.hls::stream<int, 0>"*) #7 {
entry:
  %3 = bitcast i32* %1 to [100 x i32]*
  call void @copy_out([100 x i32]* null, [100 x i32]* %3, %"class.hls::stream<int, 0>"* null, %"class.hls::stream<int, 0>"* %2)
  %4 = bitcast [100 x i32]* %3 to i32*
  call void @setup_marginal_aie_hw_stub(i32 %0, i32* %4, %"class.hls::stream<int, 0>"* %2)
  call void @copy_in([100 x i32]* null, [100 x i32]* %3, %"class.hls::stream<int, 0>"* null, %"class.hls::stream<int, 0>"* %2)
  ret void
}

declare void @setup_marginal_aie_hw_stub(i32, i32*, %"class.hls::stream<int, 0>"*)
