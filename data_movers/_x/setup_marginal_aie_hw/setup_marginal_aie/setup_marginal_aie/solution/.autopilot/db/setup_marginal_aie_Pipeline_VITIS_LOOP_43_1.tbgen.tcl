set moduleName setup_marginal_aie_Pipeline_VITIS_LOOP_43_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {setup_marginal_aie_Pipeline_VITIS_LOOP_43_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ sext_ln43 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "histogram_rows","offset": { "type": "dynamic","port_name": "histogram_rows","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln43", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln43 sc_in sc_lv 58 signal 1 } 
	{ s_TDATA sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln43", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln43", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln43 { ap_none {  { sext_ln43 in_data 0 58 } } }
	s { axis {  { s_TREADY out_acc 0 1 }  { s_TDATA out_data 1 32 }  { s_TVALID out_vld 1 1 } } }
}
