...
// ==============================================================
#ifndef XSETUP_MARGINAL_AIE_H
#define XSETUP_MARGINAL_AIE_H
...
#include <stddef.h>
#endif
#include "xsetup_marginal_aie_hw.h"
...
#ifndef __linux__
#define XSetup_marginal_aie_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XSetup_marginal_aie_ReadReg(BaseAddress, RegOffset) \
