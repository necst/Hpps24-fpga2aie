...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("m_axi_gmem0_WDATA", 256, hls_out, 0, "m_axi", "FIFONUM", 1),
	Port_Property("m_axi_gmem0_WSTRB", 32, hls_out, 0, "m_axi", "STRB", 1),
	...
	Port_Property("m_axi_gmem0_RDATA", 256, hls_in, 0, "m_axi", "FIFONUM", 1),
	...
	Port_Property("s_0_TDATA", 32, hls_out, 3, "axis", "out_data", 1),
	Port_Property("s_0_TVALID", 1, hls_out, 3, "axis", "out_vld", 1),
	Port_Property("s_0_TREADY", 1, hls_in, 3, "axis", "out_acc", 1),
	Port_Property("s_1_TDATA", 32, hls_out, 4, "axis", "out_data", 1),
	Port_Property("s_1_TVALID", 1, hls_out, 4, "axis", "out_vld", 1),
	Port_Property("s_1_TREADY", 1, hls_in, 4, "axis", "out_acc", 1),
	Port_Property("s_2_TDATA", 32, hls_out, 5, "axis", "out_data", 1),
	Port_Property("s_2_TVALID", 1, hls_out, 5, "axis", "out_vld", 1),
	Port_Property("s_2_TREADY", 1, hls_in, 5, "axis", "out_acc", 1),
	Port_Property("s_3_TDATA", 32, hls_out, 6, "axis", "out_data", 1),
	Port_Property("s_3_TVALID", 1, hls_out, 6, "axis", "out_vld", 1),
	Port_Property("s_3_TREADY", 1, hls_in, 6, "axis", "out_acc", 1),
	Port_Property("s_4_TDATA", 32, hls_out, 7, "axis", "out_data", 1),
	Port_Property("s_4_TVALID", 1, hls_out, 7, "axis", "out_vld", 1),
	Port_Property("s_4_TREADY", 1, hls_in, 7, "axis", "out_acc", 1),
	Port_Property("s_5_TDATA", 32, hls_out, 8, "axis", "out_data", 1),
	Port_Property("s_5_TVALID", 1, hls_out, 8, "axis", "out_vld", 1),
	Port_Property("s_5_TREADY", 1, hls_in, 8, "axis", "out_acc", 1),
	Port_Property("s_6_TDATA", 32, hls_out, 9, "axis", "out_data", 1),
	Port_Property("s_6_TVALID", 1, hls_out, 9, "axis", "out_vld", 1),
	Port_Property("s_6_TREADY", 1, hls_in, 9, "axis", "out_acc", 1),
	Port_Property("s_7_TDATA", 32, hls_out, 10, "axis", "out_data", 1),
	Port_Property("s_7_TVALID", 1, hls_out, 10, "axis", "out_vld", 1),
	Port_Property("s_7_TREADY", 1, hls_in, 10, "axis", "out_acc", 1),
...
const char* HLS_Design_Meta::dut_name = "setup_joint_aie";
