...
HD_PWD='/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/data_movers/_x/setup_joint_aie_hw/setup_joint_aie'
cd "$HD_PWD"
...
EAStep vitis_hls -f setup_joint_aie.tcl -messageDb vitis_hls.pb
