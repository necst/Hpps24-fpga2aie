...
open_project setup_joint_aie
set_top setup_joint_aie
# v++ -g, -D, -I, --advanced.prop kernel.setup_joint_aie.kernel_flags
add_files "/home/users/francesco.santambrogio/Downloads/Hpps24-fpga2aie/data_movers/setup_joint_aie.cpp" -cflags " -g"
...
config_export -format xo -ipname setup_joint_aie
csynth_design
export_design
close_project
